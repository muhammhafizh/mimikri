...
import HeroSection from "/public/Header-Rev-1.svg";
        ...
        <div className="mt-10 md:mt-0 flex flex-col-reverse md:flex-row">
          <section className="md:ps-28 md:pt-14 space-y-10 md:space-y-5">
            ...
            <p className="text-gray-400 text-center md:text-left">
              A Creative Clothes Manufacturing that has been help organization
              or company since 2020, Based in Tangerang Selatan.
            </p>
            <p className="text-gray-400 text-center md:text-left">
              We believe{" "}
              <span className="text-gray-500 font-bold">Identity</span> is a
              must towards building a great company and organization with
              creating <span className="text-gray-500 font-bold">Identity</span>{" "}
              is a way to introduce easily and have a big impact for
              organization growth.
            </p>
            <p className="text-gray-400 text-center md:text-left">
