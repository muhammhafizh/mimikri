  ...
  return (
    <nav className="sticky top-0">
      <div className="container mx-auto p-0 md:p-3 md:flex">
        ...
        <div
          className={`ms-auto my-8 md:space-x-10 md:flex ${
            open ? "space-x-0" : "hidden"
          }`}
        >
          <a href="#catalogue">
            <button className="font-medium block ps-9 md:ps-0">
              CATALOGUE
            </button>
          </a>
          <a href="#fashion">
            <button className="font-medium block ps-9 md:ps-0 my-1 md:my-0">
              FASHION
            </button>
          </a>
          <a href="#favourite">
            <button className="font-medium block ps-9 md:ps-0 mb-2 md:mb-0">
              FAVOURITE
            </button>
          </a>
          <a href="#lifestyle">
